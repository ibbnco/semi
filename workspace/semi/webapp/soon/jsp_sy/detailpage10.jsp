            ...
            <div class="flex flex-column max-w-lg">
                ...
                <div class="px-4">
                    <div class="single-item w-full">
                        <img src="../imgs/에브리씽1.jpg" alt="예고편" />
                        <img src="../imgs/에브리씽2.jpg" alt="예고편" />
                        <img src="../imgs/에브리씽3.jpg" alt="예고편" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="moviejp">
        ...
        <div class="flex mb-5">
            <div class="flex max-h-80">
                <img class="object-contain" src="../imgs/에브리씽.jpeg" alt="에브리씽">
            </div>
        ...
        <div class="flex mb-3 justify-content-around">
            ...
            <div class="flex">
                <div class="flex flex-column">
                    ...
                    <div>
                        <a id="open-overlay">
                            <img src="../imgs/에브리씽 스틸컷.jpg" alt="스틸컷" />
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div>
            <img style="margin: auto;" src="../imgs/에브리씽 평점.png" alt="평점">
        </div>
  <div class="container">
      <div class="row">
