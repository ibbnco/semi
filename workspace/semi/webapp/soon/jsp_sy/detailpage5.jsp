            ...
            <div class="flex flex-column max-w-lg">
                ...
                <div class="px-4">
                    <div class="single-item w-full">
                        <img src="../imgs/샤잠1.jpeg" alt="예고편" />
                        <img src="../imgs/샤잠2.jpeg" alt="예고편" />
                        <img src="../imgs/샤잠3.jpeg" alt="예고편" />
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="moviejp">
        ...
        <div class="flex mb-5">
            <div class="flex max-h-80">
                <img class="object-contain" src="../imgs/샤잠! 신들의 분노.jpeg" alt="스즈메">
            </div>
            ...
            <div class="flex flex-column">
                ...
                <div>
                    <a href="http://h.vod.cgv.co.kr/vodCGVa/86824/86824_212299_1200_128_960_540.mp4">
                        <img src="../imgs/샤잠 예고편.png" alt="예고편" />
                    </a>
                </div>
            </div>
            <div class="flex">
                <div class="flex flex-column">
                    ...
                    <div>
                        <a id="open-overlay">
                            <img src="../imgs/샤잠 스틸컷.jpeg" alt="스틸컷" />
                        </a>
                    </div>
                </div>
            </div>
