...
<%@ include file="/WEB-INF/views/common/logoHeader.jsp" %></div> --%>
    ...
    <div id="main">
        <table border="0"  id="store">
            <tr><td id="detail" class="line">솔로콤보</td><td colspan="3"></td></tr>
            <tr><td><span class="des">혼영러와 솔로들을 위한 콤보</span></td></tr>
            <tr><td rowspan="3"><img src="/images/combo1.jpg" alt="" width="400px" height="400px"></td>
                <td colspan="2" id="table3">가격<br><br>구성<br><br>구성</td>
                <td>&nbsp;&nbsp;￦4,500<br><br>&nbsp;&nbsp;솔로콤보 1개<br><br>&nbsp;&nbsp;팝콘 1개, 콜라 1개</td></tr>
