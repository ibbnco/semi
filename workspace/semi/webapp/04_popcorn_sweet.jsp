...
<%@ include file="/WEB-INF/views/common/logoHeader.jsp" %></div> --%>
    ...
    <div id="main">
        <table border="0"  id="store">
            <tr><td id="detail" class="line">카라멜 팝콘</td><td colspan="3"></td></tr>
            <tr><td><span class="des">달콤해서 콜라랑 잘 어울리는 팝콘</span></td></tr>
            <tr><td rowspan="3"><img src="/images/카라멜팝콘.jpg" alt="" width="400px" height="400px"></td>
                <td colspan="2" id="table3">가격<br><br>구성<br><br>원산지</td>
                <td>&nbsp;&nbsp;￦5,000<br><br>&nbsp;&nbsp;카라멜 팝콘 1개<br><br>&nbsp;&nbsp;카라멜시럽:캐나다산</td></tr>
