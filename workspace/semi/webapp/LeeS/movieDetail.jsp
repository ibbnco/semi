   ...
   <div id="container">
    <article id="art2">
      <h2 style="text-align: left;">영화 상세</h2>
         <form action="/LeeS/movieDelete" method="post" enctype="multipart/form-data">
            <table class="table table-striped" id="tab1">            
              <tbody class="table table-striped">
                 ...
                 <tr>
                   <th scope="row">출연진  :  ${AdminVo.actor}</th>
                 </tr>
                 <tr>
                   <th scope="row">줄거리  :  ${AdminVo.summary}</th>
                 </tr>
                 <tr>
              ...
              <form action="/LeeS/movieUpdate" method="post" enctype="multipart/form-data">             
              <table class="table table-striped" id="tab1">            
              <tbody class="table table-striped">
                 <input type="hidden" name="no" value="${AdminVo.no}">
                 <tr>   
                 ...
                 <tr>
                   <th scope="row">출연진  :  <textarea type="text" name="actor" placeholder="수정내용을 입력하세요"></textarea></th>
                 </tr>
                 <tr>
                   <th scope="row">줄거리  :  <textarea type="text" name="summary" placeholder="수정내용을 입력하세요"></textarea></th>
                 </tr>
                 <tr>
