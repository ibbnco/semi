   ...
   <div id="container">
    <article id="art2">
      <h2 style="text-align: left;">상품 상세</h2>
         <form action="/LeeS/storeDelete" method="post" enctype="multipart/form-data">
            <table class="table table-striped" id="tab1">            
              <tbody class="table table-striped">
                 ...
                 <tr>
                   <th scope="row">상품설명  :  ${AdminVo.content}</th>
                 </tr>                
                 <tr>
              ...
              <form action="/LeeS/storeUpdate" method="post" enctype="multipart/form-data">             
              <table class="table table-striped" id="tab1">            
              <tbody class="table table-striped">
                 <input type="hidden" name="no" value="${AdminVo.no}">
                 <tr>   
                 ...
                 <tr>
                   <th scope="row">상품명  :  <textarea type="text" name="content" placeholder="수정내용을 입력하세요"></textarea></th>
                 </tr>
                 <tr>
