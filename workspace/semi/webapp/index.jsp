...
<body>
    <header class="header">
        ...
        <c:if test="${loginMember == null }">
            <a href="/member/join"><img src="../imgs/회원가입.png" alt="join">
                <p class="text">회원가입</p>
            </a>
            <a href="/member/login"><img src="../imgs/로그인.png" alt="login">
                <p class="text">로그인</p>
            </a>
            <a href="/member/login" onclick="login();"><img src="../imgs/마이페이지.png" alt="mypage">
                <p class="text">마이페이지</p>
            </a>
            <a href="/member/login" onclick="login();"><img src="../imgs/고객센터.png" alt="servicecenter">
                <p class="text">고객센터</p>
            </a>
            </c:if>
            <c:if test="${loginMember != null }">
            ...
            <a href="/myPage/qnaList?page=1"><img src="../imgs/마이페이지.png" alt="mypage">
                <p class="text">마이페이지</p>
            </a>
            <a href="/member/qnaWrite"><img src="../imgs/고객센터.png" alt="servicecenter">
                <p class="text">고객센터</p>
            </a>
            </c:if>
        </div>
