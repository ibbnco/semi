...
<head>
    ...
    <div class="mypage">
      <a href="#" target='blank'><img src="/images/회원가입.png"  alt="join"><p class="text">회원가입</p></a>
      <a href="#" target='blank'><img src="/images/로그인.png" alt="login"><p class="text">로그인</p></a>
      <a href="#" target='blank'><img src="/images/마이페이지.png" alt="mypage"><p class="text">마이페이지</p></a>
      <a href="#" target='blank'><img src="/images/고객센터.png" alt="servicecenter"><p class="text">고객센터</p></a>
    </div>
    </header>
