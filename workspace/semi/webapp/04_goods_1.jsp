...
<%@ include file="/WEB-INF/views/common/logoHeader.jsp" %></div> --%>
    ...
    <div id="main">
        <table border="0" id="store">
            <tr><td id="detail" class="line">텀블러</td><td colspan="3"></td></tr>
            <tr><td><span class="des"></span></td></tr>
            <tr><td rowspan="3"><img src="/images/marveltumbler.jpg" alt="" width="300px" height="300px"></td>
                <td colspan="2" id="table3">가격<br><br>구성<br><br>설명</td>
                <td>&nbsp;&nbsp;￦10,500<br><br>&nbsp;&nbsp;텀블러 1개<br><br>&nbsp;&nbsp;마블 텀블러</td></tr>
