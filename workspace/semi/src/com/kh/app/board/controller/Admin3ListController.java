...
@WebServlet("/LeeS/admin3")
public class Admin3ListController extends HttpServlet {
	
private Admin3Service as = new Admin3Service();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			req.getRequestDispatcher("/LeeS/admin3.jsp").forward(req, resp);
