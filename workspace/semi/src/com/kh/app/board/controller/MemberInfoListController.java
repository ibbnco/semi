...
import com.kh.app.board.service.MemeberInfoService;
import com.kh.app.board.vo.AdminVo;
import com.kh.app.board.vo.GradeVo;
import com.kh.app.util.page.PageVo;

@WebServlet("/LeeS/memberInfo")
public class MemberInfoListController extends HttpServlet {
	
private MemeberInfoService as = new MemeberInfoService();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			req.getRequestDispatcher("/LeeS/memberInfo.jsp").forward(req, resp);
