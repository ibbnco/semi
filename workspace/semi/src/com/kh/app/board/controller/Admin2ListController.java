...
@WebServlet("/LeeS/admin2")
public class Admin2ListController extends HttpServlet {
	
private Admin2Service as = new Admin2Service();
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		try {
			...
			req.getRequestDispatcher("/LeeS/admin2.jsp").forward(req, resp);
